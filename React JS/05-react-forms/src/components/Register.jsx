...
export default function Register() {
  //The system displays an error message if the user password and password confirmation do not match
  const [passwordNotEqual, setPasswordNotEqual] = useState(false);

  function handleSubmit(e) {
    e.preventDefault();

    // FormData is used to easily retrieve all data from the form.
    ...
    if (data.password !== data.repassword) {
      ...
      return; // Form not submitted, process stopped
    }
